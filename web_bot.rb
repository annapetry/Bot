...
# Class that responds to HTTP/Web requests and interacts with the bot class
class BotServlet < WEBrick::HTTPServlet::AbstractServlet
  
  # A basic HTML template consisting of a basic page with a form and text entry box for the user to converse with our bot. It uses some placeholder text (%RESPONSE%) so the bot's responses can be substituted in easily later.
  @@html = %q{
    <html><body>
      <form method="get">
        <h1>Talk To A Bot</h1>
